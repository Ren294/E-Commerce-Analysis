...
run_silver_order_items = create_spark_task(
    'run_silver_order_items', 'silver_order_items')
...
start_dag >> check_data_in_hdfs >> check_create_hdfs_directory >> run_silver_customer
...
run_silver_order_reviews >> run_silver_order_payments >> end_dag
